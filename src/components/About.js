      ...
      <div className="heroo">
        <div className="content">
          ...
          <p className="mb-0 text-center text-white">
            “OUNCES OF SPEEDYDRY (PREVENTION) ARE WORTH POUNDS OF DOLLARS
            (CURES)”
          </p>
        </div>
      </div>
      <div className="card my-4">
        <div className="card-body">
          ...
          <p className="card-text">
            ...
            sure would make our life easier. Unfortunately, for us, we have to
            produce it in specially crafted batches. We can promise you this
            though, we will show you a return on your product investment of at
            least 5 times your money. Give us a fair trial by simply tailing it
            in at the end of one of your difficult runs and you will see the
            results. Or return the product, no questions asked, no restocking
            fees, no shipping charges (to or from), no hidden expenses – a full
            refund – our promise to you.
          </p>
        </div>
      </div>
      <div className="card my-4">
        <div className="card-body">
          ...
          <p className="card-text">
            Our formulation is patented and award-winning (A GATF InterTech
            Technology Award Winner). The product has spent a ridiculous amount
            of hours in the lab and in the press room over the years and has
